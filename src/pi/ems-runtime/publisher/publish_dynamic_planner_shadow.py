...
BRANCH = "main"
TARGET = "docs/data/energy-planner-shadow-dynamic.json"
SOURCE = Path("/home/jeroen/ems/data/energy-planner-shadow-dynamic.json")
...
headers = {
    ...
    "User-Agent": "EMS-Pi-Dynamic-Planner-Publisher",
}
...
body = {
    "message": "chore: publish Dynamic Pi Planner shadow snapshot",
    "content": content,
    "branch": BRANCH,
}
if sha:
...
print("PASS: Dynamic Pi Planner shadow published")
print("target:", TARGET)
