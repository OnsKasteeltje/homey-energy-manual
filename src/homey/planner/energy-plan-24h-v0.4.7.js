...
const VERSION='EM2_ENERGY_PLAN_24H_V0.4.7',STEP_MS=15*60000,MAX_SLOTS=96;
...
try{
  ...
  const r=await fetch(url,{headers:{'User-Agent':'Homey-EMS-Planner-v0.4.7'}});if(!r.ok)throw new Error(`HTTP ${r.status}`);
