...
// Flow candidate: EM v2 | 60 Actuator | EV Power v0.2.15 CONTROL-AUTHORITY
// Flow ID: fea23193-a03f-49dd-9780-7e72ee48747d
// Derived from live v0.2.14: 2026-09-25
// Stale Core/Easee chargeState is observability only; fresh Gate authority controls execution.

// === HomeyScript card 1: 10a00000-0000-4000-8000-000000000002 ===
// EV Actuator v0.2.15 CONTROL-AUTHORITY
const VERSION='EM2_EV_ACTUATOR_V0.2.15',CHARGER_ID='4d0b6913-d940-474e-95d6-b43f194c4119',FRESH_MS=120000;
...
try{
  ...
  const deadlineAuthority=deadlineEligible&&gateFresh&&gatePass&&tokenOK&&adapterSafe&&numericOK;
...
// EV Actuator v0.2.15 POST-SESSION CONTROL-AUTHORITY
const VERSION='EM2_EV_ACTUATOR_V0.2.15',CHARGER_ID='4d0b6913-d940-474e-95d6-b43f194c4119',FRESH_MS=120000;
const IDS={live:'8d47e98d-e4bc-4f47-8c02-c2aca7f7a978',status:'ea1f8a44-2f6c-490e-9b86-bae761886cf9',intent:'04b57041-dd7f-41f7-a00a-f023afb1ccee',adapter:'f2118322-d59d-4aa8-b478-234effc3983c',gate:'4c66836b-77ae-43b5-b8e0-b32af15b57bc',state:'8e1efbb0-7999-494c-9429-7d274afacd79'};
const parse=x=>{try{return JSON.parse(String(x??''));}catch{return null;}};
const num=x=>{if(x===null||x===undefined||x==='')return null;const n=Number(x);return Number.isFinite(n)?n:null;};
...
const gatePass=gate?.finalStatus==='PASS';
const deadlineAuthority=deadlineEligible&&gateFresh&&gatePass&&tokenOK&&adapterSafe&&numericOK;
const normalCoherent=liveVar.value===true&&intentFresh&&gateFresh&&gatePass&&tokenOK&&adapterSafe&&numericOK;
