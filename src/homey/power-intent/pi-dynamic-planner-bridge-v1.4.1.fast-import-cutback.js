// PI Dynamic Planner -> EM2 Power Intent bridge v1.4.1 FAST-IMPORT-CUTBACK.
...
const POLICY='PI_DYNAMIC_PLANNER_BRIDGE_V1.4.1_FAST_IMPORT_CUTBACK';
...
let realtime={schema:'EM2_EV_REALTIME_EXECUTION_V0.1',eligible:false,applied:false,fallbackReason:null,envelopeSchema:null,envelopeAllowed:false,minA:0,maxA:0,p1W:null,p1AgeSec:null,chargeState:null,evActualW:null,evPowerAgeSec:null,counterfactualSurplusW:null,candidateA:null,candidateW:null,importReductionA:0,plannerTargetA:0,plannerTargetW:0,phasePolicy:null,phaseShadow:{schema:'EM2_EV_PHASE_EXECUTION_SHADOW_V0.1',mode:'OFF',requestedA:0,requestedW:0,reason:'NOT_EVALUATED',modeSinceAt:null,shadow:true,deviceWrites:false,controlWrites:false}};
