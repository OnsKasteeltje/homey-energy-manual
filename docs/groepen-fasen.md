...
| Elektrische boiler | Nog te bepalen | Nog te bepalen | **Open** | Wel als afzonderlijke energieregelaar in Homey bekend, maar fase/groep is op deze pagina nog niet met een geïsoleerde test bevestigd. |
...
| Waterkoker | Nog te bepalen | Nog te bepalen | **Open** | Korte testbelasting; fasekoppeling nog te bevestigen. |
...
De eerstvolgende nuttige identificaties zijn de **boiler, vaatwasser, kookplaat/fornuis, Quooker en PV-omvormers**. Zodra de fase bekend is, kan het exacte groepnummer worden toegevoegd door de betreffende automaat gecontroleerd uit te schakelen of de kastindeling te vergelijken met de bedrading.
