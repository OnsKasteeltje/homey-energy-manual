(function(){
  ...
  function patchNode(title, load){
    ...
    // Alleen de verticale aftakking naar het apparaat mag hier worden aangepast.
    // De horizontale distributiebus wordt door live-energy-v2.8.66 berekend op basis
    // van de cumulatieve downstream belasting en mag hier niet worden geneutraliseerd.
