(function(){
  // Homepage architecture v1.5: resilient Tesla deadline status overlay.
  ...
  function scheduleEnhance(){
    ...
    enhanceTimer=setTimeout(()=>{enhance().catch(()=>{});},80);
  }
  ...
  script.onload=()=>{
    ...
    // Periodic re-assertion prevents later base rerenders from reverting the deadline card.
