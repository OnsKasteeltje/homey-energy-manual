  ...
  const boot=async root=>{
    ...
    try{
      if(!hasRendered(root)){
        ...
        if(!ok){await loadScript('../javascripts/planner-shadow.js?lifecycle=9');ok=await waitRendered(root,8000);}
        if(!ok){loaded.delete(root);return;}
      }
      await loadScript('../javascripts/planner-axes-v1.1.0.js?lifecycle=9').catch(()=>{});
      await loadScript('../javascripts/planner-price-availability-v1.0.0.js?lifecycle=2').catch(()=>{});
      await loadScript('../javascripts/planner-price-live-refresh-v1.0.0.js?lifecycle=1').catch(()=>{});
      await loadScript('../javascripts/planner-ww-multislot-v1.1.0.js?lifecycle=10').catch(()=>{});
      await loadScript('../javascripts/planner-flex-energy-v1.0.0.js?lifecycle=9').catch(()=>{});
      await loadScript('../javascripts/planner-action-details-v1.0.1.js?lifecycle=9').catch(()=>{});
      await loadScript('../javascripts/planner-forecast-labels-v1.0.0.js?lifecycle=9').catch(()=>{});
      await loadScript('../javascripts/planner-device-tabs-v1.0.3.js?lifecycle=9').catch(()=>{});
      await loadScript('../javascripts/planner-control-evidence-v1.0.0.js?lifecycle=9').catch(()=>{});
