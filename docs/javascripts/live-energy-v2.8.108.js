(function(){
  ...
  function renderRaw(raw,freshness){
    ...
    document.dispatchEvent(new CustomEvent('liveenergyrendered',{detail:{stateRevision:meta.state_revision??null,at:new Date().toISOString()}}));
  }
  ...
  window.HomeEnergyFrontend.liveEnergyRenderer='2.8.108';
