(() => {
  ...
  function findPrimaryBoilerRow(){
    ...
    if(!plannerSection)return null;
    return [...plannerSection.querySelectorAll('.ps-action-row')].find(r=>String(r.querySelector('.ps-action-name')?.textContent||'').trim()==='Boiler')||null;
  }
  function render(payload){
    ...
    row.classList.add('ps-ww-primary-owner');
