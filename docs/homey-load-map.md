...
<div id="homey-load-map" class="hlm-root">
  ...
  <div class="hlm-panel">
    ...
    <div class="hlm-scroll"><svg id="hlm-load-chart" viewBox="0 0 980 170" role="img" aria-label="Cumulatieve Homey-load per minuut"></svg></div>
  </div>
