...
class SyncEnergyContractTests(unittest.TestCase):
    def write_docs(self, root: Path, runtime_version: str, canonical_version: str, publisher: str = "PUB1"):
        runtime = {"meta": {"schema_version": runtime_version, "publisher_version": publisher}}
        schema = {
            ...
            "properties": {
                "meta": {
                    "properties": {
                        ...
                        "publisher_version": {"const": publisher},
                    }
                }
            },
        }
    ...
    def test_forward_minor_is_synchronized(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(schema["properties"]["meta"]["properties"]["schema_version"]["const"], "2.13")
    ...
    def test_major_change_fails_closed(self):
        with tempfile.TemporaryDirectory() as tmp:
