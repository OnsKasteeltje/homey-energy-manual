...
assert(candidate.includes("plannerDateParts=new Intl.DateTimeFormat('en-CA'"));
assert(candidate.includes("plannerToday=`${plannerDatePart('year')}-${plannerDatePart('month')}-${plannerDatePart('day')}`"));
assert(!candidate.includes('plannerToday=today'));
